...
def _save_chi2_diagnostics(
    ...
    """Compute chi2 diagnostic tables, save them, and return the computed values."""
    ...
    return {
        ...
        "svd_mode_contributions": svd_mode_contributions,
    }
...
def save_tables(
    ...
    extra_results = _save_all_tables(context, data, paths)
    report_results = {**results, **extra_results}
    ...
    return {
        "saved_tables": {k: str(v) for k, v in paths.items()},
        **extra_results,
    }
